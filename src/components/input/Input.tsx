...
const InputComponent = (props:InputProps) => {
  ...
  const onClear = () => props.name ? props.onChange({target:{name:props.name, value:''}} as React.ChangeEvent<HTMLInputElement>) : props.onChange('')
  const handleOnChange = props.name ? props.onChange : (e: any) => props.onChange(e.target.value)
